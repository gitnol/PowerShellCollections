...
164 Skripte. 49 mit `.SYNOPSIS` (30%), 105 weitere mit einer Kurzbeschreibung aus dem ersten Kommentar.
...
Davon 35 nebenwirkungsfrei, 1 mit Syntaxfehlern.
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Create-GPOAnalysis.ps1](scripts/active-directory/gpo/Create-GPOAnalysis.ps1) |  | _(aus Kommentar)_ GPO Settings Analysis Script |
| [Get-GPO_GPP_ItemLevelTargeting.ps1](scripts/active-directory/gpo/Get-GPO_GPP_ItemLevelTargeting.ps1) |  | _(aus Kommentar)_ Diese Funktion liefert die zielgruppenbasierte Zuordnung innerhalb von GPPs bei GPOs. |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [compare-aduser-groups.ps1](scripts/active-directory/group-membership/compare-aduser-groups.ps1) |  | _(aus Kommentar)_ Change the two lines if you do not want to input it |
| [Copy-ADGroupMember.ps1](scripts/active-directory/group-membership/Copy-ADGroupMember.ps1) | `def` | _keine Beschreibung_ |
| [Get-RecursiveGroupSIDs-Vergleich-zu-Get-ADPrincipalGroupMembership.ps1](scripts/active-directory/group-membership/Get-RecursiveGroupSIDs-Vergleich-zu-Get-ADPrincipalGroupMembership.ps1) |  | _(aus Kommentar)_ ($user.MemberOf).count |
| [resolve-ad-groups-recursively.ps1](scripts/active-directory/group-membership/resolve-ad-groups-recursively.ps1) |  | _(aus Kommentar)_ CaseSensitive |
...
| [temporary-groupmembership_v2.ps1](scripts/active-directory/group-membership/temporary/temporary-groupmembership_v2.ps1) |  | _(aus Kommentar)_ .SYNOPSIS |
| [temporary-groupmembership.ps1](scripts/active-directory/group-membership/temporary/temporary-groupmembership.ps1) |  | _(aus Kommentar)_ Version 1.0 geklaut aus diversen Quellen und abgeändert durch Gitnol am 10.08.2021 |
...
| [get-enabled_ad_user_with_managers.ps1](scripts/active-directory/inventory/get-enabled_ad_user_with_managers.ps1) |  | _(aus Kommentar)_ Import the Active Directory module |
| [get-inactive-user-of-specific-group.ps1](scripts/active-directory/inventory/get-inactive-user-of-specific-group.ps1) |  | _(aus Kommentar)_ This Script helps to identify, which Office 365 or Microsoft 365 Licenses could perhaps be available for reuse. |

## `scripts/active-directory/ldap/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [LDAPServer.ps1](scripts/active-directory/ldap/LDAPServer.ps1) |  | _(aus Kommentar)_ [string]$Filter = "(telephoneNumber=13*)", |
...
| [get-user-logons.ps1](scripts/active-directory/logon-events/get-user-logons.ps1) |  | _(aus Kommentar)_ This Script returns all logon events of specific EventIDs or user names |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [_dump-ticketsize.1.7.ps1](scripts/active-directory/token-size/_dump-ticketsize.1.7.ps1) |  | _(aus Kommentar)_ collects all Users of the local domain and exports their groupmember count and estimated ticketsize |
| [_Get-TokenSizeReport.ps1](scripts/active-directory/token-size/_Get-TokenSizeReport.ps1) |  | _(aus Kommentar)_ Source: https://github.com/jeremyts/ActiveDirectoryDomainServices/blob/master/Audit/Get-TokenSizeReport.ps1 |

## `scripts/active-directory/user-photo/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Set-UserPhotoHybrid.ps1](scripts/active-directory/user-photo/Set-UserPhotoHybrid.ps1) |  | _(aus Kommentar)_ 1. Lokales AD (96x96) |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [excel-to-pscustomobject.ps1](scripts/applications/excel/excel-to-pscustomobject.ps1) |  | _(aus Kommentar)_ This function enables you to copy information from Excel to a pscustomobject |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [FileZilla.ps1](scripts/applications/filezilla/FileZilla.ps1) | `def` | _(aus Kommentar)_ $erg = Parse-FileZillaLog "D:\FILEZILLA_LOGS_bis_20250508\FILEZILLA.log" |
| [Get-FtpLoginSummary.ps1](scripts/applications/filezilla/Get-FtpLoginSummary.ps1) |  | _(aus Kommentar)_ .SYNOPSIS |

## `scripts/applications/kyocera/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Get-PrinterOID.ps1](scripts/applications/kyocera/Get-PrinterOID.ps1) |  | _(aus Kommentar)_ See also here for some kyocera OIDs |

## `scripts/applications/openscape-business/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [OZBiz-Functions.psm1](scripts/applications/openscape-business/OZBiz-Functions.psm1) | `def` | Meldet sich an der OSBiz API an und gibt die Session-ID zurück. |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Parse-TeamViewerLogFile.ps1](scripts/applications/teamviewer/Parse-TeamViewerLogFile.ps1) |  | _(aus Kommentar)_ Look here: https://medium.com/mii-cybersec/digital-forensic-artifact-of-teamviewer-application-cfd6290dc0a7 |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [MoreAPITests.ps1](scripts/applications/zammad/MoreAPITests.ps1) | `def` | _keine Beschreibung_ |
| [OnceMoreAPITests.ps1](scripts/applications/zammad/OnceMoreAPITests.ps1) | `def` | _(aus Kommentar)_ Zammad API PowerShell Modul |
| [SomeAPITests.ps1](scripts/applications/zammad/SomeAPITests.ps1) |  | _(aus Kommentar)_ Base URL of Zammad API |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Fileserver-Einzelberechtigungen-fuer-User.ps1](scripts/filesystem/permissions/Fileserver-Einzelberechtigungen-fuer-User.ps1) |  | _(aus Kommentar)_ 1x alle Benutzer-Accounts in Hashtable |
...
| [Manage-SharedMailboxPermissions.ps1](scripts/messaging/exchange/Manage-SharedMailboxPermissions.ps1) |  | _(aus Kommentar)_ HINWEIS: DIESE DATEI MUSS MIT DER KODIERUNG "UTF-8 mit BOM" GESPEICHERT WERDEN, |
| [New-SharedMailboxWorkflow.ps1](scripts/messaging/exchange/New-SharedMailboxWorkflow.ps1) |  | _(aus Kommentar)_ HINWEIS: DIESE DATEI MUSS MIT DER KODIERUNG "UTF-8 mit BOM" GESPEICHERT WERDEN. |

## `scripts/messaging/mailstore/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Get-MailStore-API-Function-Reference.ps1](scripts/messaging/mailstore/Get-MailStore-API-Function-Reference.ps1) |  | _(aus Kommentar)_ Because Mailstore does not give OpenAPI / Swagger Files... i have to structure it on my own... :( |
| [Mailstore-Scripts.ps1](scripts/messaging/mailstore/Mailstore-Scripts.ps1) |  | _(aus Kommentar)_ Ensure the Active Directory module is imported |
| [Mailstore-Scripts2.ps1](scripts/messaging/mailstore/Mailstore-Scripts2.ps1) |  | _(aus Kommentar)_ # Private Methods                                                  # |
| [MailStoreFunctionsFromAPI.ps1](scripts/messaging/mailstore/MailStoreFunctionsFromAPI.ps1) | `def` | _keine Beschreibung_ |
| [test.ps1](scripts/messaging/mailstore/test.ps1) | `def` | **Syntaxfehler (6)** - _keine Beschreibung_ |

## `scripts/messaging/mailstore/api-wrapper/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [MS.PS.Lib.psm1](scripts/messaging/mailstore/api-wrapper/MS.PS.Lib.psm1) |  | _(aus Kommentar)_ PowerShell Scripting Library |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [user-to-domain-communication.ps1](scripts/messaging/nospamproxy/user-to-domain-communication.ps1) |  | _(aus Kommentar)_ Parameter: Start- und Enddatum für den Abfragezeitraum |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Check-ADGroupIntegrity-Multi.ps1](scripts/monitoring/prtg/ad-group-integrity/Check-ADGroupIntegrity-Multi.ps1) |  | _(aus Kommentar)_ .SYNOPSIS |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Monitor-Webchanges.ps1](scripts/monitoring/web-changes/Monitor-Webchanges.ps1) | `def` | _(aus Kommentar)_ Effiziente Hash-Berechnung |

## `scripts/network/aruba/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [aruba.ps1](scripts/network/aruba/aruba.ps1) |  | _(aus Kommentar)_ Just a demo script to connect to aruba switches and get the mac address table |
| [aruba1.ps1](scripts/network/aruba/aruba1.ps1) |  | _(aus Kommentar)_ iwr https://www.wireshark.org/json/manuf.json -OutFile C:\install\manuf.json |

## `scripts/network/dhcp/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [get-dhcpserver-leases_v2.ps1](scripts/network/dhcp/get-dhcpserver-leases_v2.ps1) |  | _(aus Kommentar)_ DHCP Leases aus allen autorisierten DHCP-Servern der Domäne abfragen und MAC-Adressen in verschiedenen Formaten ausgeben |
| [get-dhcpserver-leases.ps1](scripts/network/dhcp/get-dhcpserver-leases.ps1) |  | _(aus Kommentar)_ This script get all DHCP Leases from the DHCP Server and list then together with the MAC Addresses in the valid RFC formats |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Cleanup-Firewall-Rules.ps1](scripts/network/firewall/Cleanup-Firewall-Rules.ps1) |  | _(aus Kommentar)_ This script removes duplicate firewall rules |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Set-WakeOnLAN-AdapterOptions.ps1](scripts/network/wake-on-lan/Set-WakeOnLAN-AdapterOptions.ps1) |  | _keine Beschreibung_ |
| [Wake-On-Lan.ps1](scripts/network/wake-on-lan/Wake-On-Lan.ps1) | `def` | Sendet ein Wake-on-LAN Magic Packet an eine MAC-Adresse. |

## `scripts/security/bitlocker/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [bitlocker-status-de.ps1](scripts/security/bitlocker/bitlocker-status-de.ps1) |  | _(aus Kommentar)_ Powershell Version 6 oder höher erzwingen |
| [bitlocker-status-en.ps1](scripts/security/bitlocker/bitlocker-status-en.ps1) |  | _(aus Kommentar)_ Force Usage of Powershell Version 6 or Higher |

## `scripts/security/certificates/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Generate-Certificate.ps1](scripts/security/certificates/Generate-Certificate.ps1) |  | _(aus Kommentar)_ .SYNOPSIS |
| [Replace-VMWare-Certificates.ps1](scripts/security/certificates/Replace-VMWare-Certificates.ps1) |  | _(aus Kommentar)_ .SYNOPSIS |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Suche_nach_log4j_Dateien_optimiert.ps1](scripts/security/log4j/Suche_nach_log4j_Dateien_optimiert.ps1) |  | _(aus Kommentar)_ Vorbereitungen |
| [Suche_nach_log4j_Dateien.ps1](scripts/security/log4j/Suche_nach_log4j_Dateien.ps1) |  | _(aus Kommentar)_ Todo ... automatisches Löschen implementieren per Flag...ggf mit einer Filelist Denylist oder Allowlist |

## `scripts/security/passwords/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [check-for-bad-passwords.ps1](scripts/security/passwords/check-for-bad-passwords.ps1) |  | _(aus Kommentar)_ This little script checks the AD Users of specific groups, if they use a weak password |

## `scripts/security/secure-boot/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Check-MultipleHostsSecureBoot.ps1](scripts/security/secure-boot/Check-MultipleHostsSecureBoot.ps1) |  | _(aus Kommentar)_ Only PowerShell 7+ (ForEach-Object -Parallel) |
| [Invoke-SecureBootCertUpdate_simple.ps1](scripts/security/secure-boot/Invoke-SecureBootCertUpdate_simple.ps1) |  | _(aus Kommentar)_ .SYNOPSIS |
| [Invoke-SecureBootCertUpdate.ps1](scripts/security/secure-boot/Invoke-SecureBootCertUpdate.ps1) |  | _(aus Kommentar)_ .SYNOPSIS |
| [Test-MultipleHostsSecureBoot.ps1](scripts/security/secure-boot/Test-MultipleHostsSecureBoot.ps1) |  | _(aus Kommentar)_ Only Powershell 6 and above (because of ForEach-Object -Parallel) |
| [Test-SecureBootCert2023.ps1](scripts/security/secure-boot/Test-SecureBootCert2023.ps1) |  | _(aus Kommentar)_ .SYNOPSIS |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Get-PCActivityTimeline.ps1](scripts/windows/activity-timeline/Get-PCActivityTimeline.ps1) |  | _(aus Kommentar)_ .SYNOPSIS |
| [Test-PCActivityTimeline.ps1](scripts/windows/activity-timeline/Test-PCActivityTimeline.ps1) |  | _(aus Kommentar)_ .SYNOPSIS |
...
| [Get-ComputerOnlineStatus.ps1](scripts/windows/availability/Get-ComputerOnlineStatus.ps1) |  | _(aus Kommentar)_ # This is also functioning for powershell 5 where "foreach-object -parallel" is missing |
...
| [Clear-OldTempFiles.ps1](scripts/windows/cleanup/Clear-OldTempFiles.ps1) | `def` | Gibt eine Liste bereinigungswürdiger Verzeichnispfade zurück. Bezieht sowohl systemweite als auch benutzerspezifische Pfade ein. |
| [remove-old-user-profiles.ps1](scripts/windows/cleanup/remove-old-user-profiles.ps1) |  | _(aus Kommentar)_ Bei WhatIf ist es True, ansonsten False |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Elevate.ps1](scripts/windows/elevation/Elevate.ps1) | `def` | _(aus Kommentar)_ What does this function do? |
| [Elevate(Old).ps1](scripts/windows/elevation/Elevate(Old).ps1) | `def` | _(aus Kommentar)_ Old Version of Elevate.ps1 |
...
| [Simple-EventLog-Setup.ps1](scripts/windows/eventlog/Simple-EventLog-Setup.ps1) |  | _(aus Kommentar)_ Einfaches PowerShell Script zum Erstellen der Event Log-Quelle |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Get-Process-CPU-Usage-DomainWide.ps1](scripts/windows/processes/Get-Process-CPU-Usage-DomainWide.ps1) |  | _(aus Kommentar)_ This script queries remotely the top X process and collect these. |
| [log-start-stop-process.ps1](scripts/windows/processes/log-start-stop-process.ps1) |  | _(aus Kommentar)_ File to which the processes should be exported to in "json" format. |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Check-RemoteRegistry.ps1](scripts/windows/registry/Check-RemoteRegistry.ps1) |  | _(aus Kommentar)_ Test Netzwerkverbindung |
| [get-remote-registry-values.ps1](scripts/windows/registry/get-remote-registry-values.ps1) |  | _(aus Kommentar)_ Get the remote registry Value of online computers, |

## `scripts/windows/scheduled-tasks/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Export-Tasks.ps1](scripts/windows/scheduled-tasks/Export-Tasks.ps1) | `def` | _keine Beschreibung_ |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Check-ServiceOnMultipleClients.ps1](scripts/windows/services/Check-ServiceOnMultipleClients.ps1) |  | _(aus Kommentar)_ Annahme: $Computer ist eine Liste/Array von Computernamen |
...
| [Set-ServiceStatupType.ps1](scripts/windows/services/Set-ServiceStatupType.ps1) | `def` | _(aus Kommentar)_ Mapping of abbreviations to full names |

## `scripts/windows/sessions/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [check-inactive-idle-sessions.ps1](scripts/windows/sessions/check-inactive-idle-sessions.ps1) |  | _(aus Kommentar)_ I have added this script to reddit on 20240803 |
| [Get-IdleTime-Single-User.ps1](scripts/windows/sessions/Get-IdleTime-Single-User.ps1) |  | _keine Beschreibung_ |
| [Get-LastInteractiveUserLogons.ps1](scripts/windows/sessions/Get-LastInteractiveUserLogons.ps1) | `def` | _keine Beschreibung_ |
| [Get-LoggedInUsers_CIMVariant.ps1](scripts/windows/sessions/Get-LoggedInUsers_CIMVariant.ps1) | `def` | _(aus Kommentar)_ Bug in Powershell for Version 7 (checked on Version 7.4.4) : https://github.com/PowerShell/PowerShell/issues/20829 |
| [Get-LoggedInUsers_InvokeCommandVariant.ps1](scripts/windows/sessions/Get-LoggedInUsers_InvokeCommandVariant.ps1) |  | _(aus Kommentar)_ Bug in Powershell for Version 7 (checked on Version 7.4.4) : https://github.com/PowerShell/PowerShell/issues/20829 |
| [get-UserSessionInfos__remove-UserSessions.ps1](scripts/windows/sessions/get-UserSessionInfos__remove-UserSessions.ps1) |  | _(aus Kommentar)_ This Script is able to get remote user sessions information and is able to log off the (discconnected \| connected) remote user sessions |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Create-ScheduledTasksWithXML.ps1](scripts/windows/shadow-copy/Create-ScheduledTasksWithXML.ps1) |  | _(aus Kommentar)_ vssadmin list shadowstorage |
| [Create-Spontaneous-Shadow-Copy.ps1](scripts/windows/shadow-copy/Create-Spontaneous-Shadow-Copy.ps1) | `def` | _(aus Kommentar)_ Beispielaufruf: |
| [Enable-ShadowCopyC.ps1](scripts/windows/shadow-copy/Enable-ShadowCopyC.ps1) |  | _(aus Kommentar)_ $volume = Get-CimInstance -Query "SELECT * FROM Win32_Volume WHERE DriveLetter = 'C:' AND FileSystem = 'NTFS'" |
| [test.ps1](scripts/windows/shadow-copy/test.ps1) |  | _(aus Kommentar)_ $shadowStorage = Get-CimInstance -Namespace root\cimv2 -ClassName Win32_ShadowStorage |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [Set-WbemTracing.ps1](scripts/windows/wmi/Set-WbemTracing.ps1) | `def` | _(aus Kommentar)_ .SYNOPSIS |
...
| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [PSCustomObjectWithIndexColumn.ps1](snippets/PSCustomObjectWithIndexColumn.ps1) | `def` | _(aus Kommentar)_ DO NOT USE THIS FUNCTION, IF YOU DON'T WANT YOUR SOURCE PSCUSUTOMOBJECT!!! |
| [Script-Block-Parameters.ps1](snippets/Script-Block-Parameters.ps1) |  | _(aus Kommentar)_ Source: https://stackoverflow.com/questions/16347214/pass-arguments-to-a-scriptblock-in-powershell |

## `snippets/graph-traversal/`

| Skript | | Beschreibung |
| ------ | --- | ------------ |
| [BFS.ps1](snippets/graph-traversal/BFS.ps1) | `def` | _(aus Kommentar)_ mit Richtung. Demo |
| [Version-8.ps1](snippets/graph-traversal/Version-8.ps1) | `def` | _(aus Kommentar)_ Demo Usage with a JSON graph structure |
