<#
.SYNOPSIS
    Aeltere Sammlung von MailStore-API-Funktionen samt Anwendungsbeispielen
    (Stand v2).

.DESCRIPTION
    Definiert rund 85 Funktionen um die MailStore-Administrations-API und
    enthaelt dazwischen konkrete Auswertungen, etwa zu Benutzerrechten auf
    Archivordnern.

    Konkurriert mit MailStoreApiFunctions.ps1 und MailStoreSnippets_v1.ps1:
    v2 ist eine echte Obermenge von v1 - 19 der 20 Funktionen aus v1 kommen
    hier ebenfalls vor. Welcher Bestand kuenftig gilt, ist offen, siehe
    docs/BACKLOG.md.
