...
# Compact-MSMasterDatabase einen leeren Parameter ausgegeben
#     [Parameter(Mandatory = $, ...)]
#     []$,
# Die beiden Zeilen sind entfernt; die korrekte Fassung steht in
# MailStoreApiFunctions.ps1. Der Generator selbst ist nicht geprueft -
# siehe docs/BACKLOG.md.
# Vollstaendiger und gepflegter ist MailStoreApiFunctions.ps1.
