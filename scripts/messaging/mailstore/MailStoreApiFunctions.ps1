<#
.SYNOPSIS
    PowerShell-Huelle um die Administrations-API des MailStore Server.

.DESCRIPTION
    Eine Funktion je API-Methode, jeweils als duenner Aufruf von
    Invoke-MSApiCall. Erzeugt aus der Online-Funktionsreferenz von MailStore
    durch New-MailStoreApiFunctionReference.ps1, weil MailStore keine
    OpenAPI- oder Swagger-Beschreibung veroeffentlicht.

    Dies ist der vollstaendigste der drei MailStore-Funktionsbestaende hier;
    MailStoreSnippets_v1 und _v2 sind aeltere Staende. Siehe docs/BACKLOG.md.
