<#
.SYNOPSIS
    Ermittelt fuer alle Domaenenbenutzer die geschaetzte Kerberos-Tokengroesse
    und meldet die groessten.

.DESCRIPTION
    Zaehlt je Benutzer die rekursiven Gruppenmitgliedschaften, unterscheidet
    dabei domaenenlokale, globale und universelle Gruppen sowie SID-History
    und rechnet daraus die zu erwartende Tokengroesse aus. Ergebnis ist ein
    CSV-Report der groessten Konten.
...
.NOTES
    FREMDCODE. Original von Jeremy Saunders (jhouseconsulting.com),
    Release 1.8, abgeleitet von CheckMaxTokenSize.ps1 von Tim Springston.
    Quelle: https://github.com/jeremyts/ActiveDirectoryDomainServices
    Gehoert eigentlich nach third-party/, siehe docs/BACKLOG.md.
#>

# Source: https://github.com/jeremyts/ActiveDirectoryDomainServices/blob/master/Audit/Get-TokenSizeReport.ps1
<#
...
$ReferenceFile = "C.\temp\KerberosTokenSizeReport.csv"
